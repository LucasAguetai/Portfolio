...
const TERMINAL_LINES = {
  fr: [
    { html: '<span class="t-prompt">lucas@aguetai:~$</span> <span class="t-cmd">whoami</span>', delay: 400 },
    { html: '<span class="t-out">Lucas Aguetaï — Ingénieur cybersécurité</span>', delay: 250 },
    { html: '<span class="t-prompt">lucas@aguetai:~$</span> <span class="t-cmd">cat skills.txt</span>', delay: 700 },
    { html: '<span class="t-out">[ pentest, réseaux, python, C, linux, CTF ]</span>', delay: 250 },
    { html: '<span class="t-prompt">lucas@aguetai:~$</span> <span class="t-cmd">nmap -sV lucas.aguetai.fr</span>', delay: 800 },
    ...
    { html: '<span class="t-prompt">lucas@aguetai:~$</span> <span class="t-cmd">sudo ./hire_me.sh</span>', delay: 900 },
    ...
    { html: '<span class="t-prompt">lucas@aguetai:~$</span> <span class="cursor-blink">▊</span>', delay: 300 },
  ],
  en: [
    { html: '<span class="t-prompt">lucas@aguetai:~$</span> <span class="t-cmd">whoami</span>', delay: 400 },
